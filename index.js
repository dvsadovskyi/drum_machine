        ...
        <div id="drum-machine">
            ...
            <div className="control-area">
                <div className="pads">
                    ...
                    <div onClick={handlePlay} className="drum-pad" id={bank ? "Heater-2" : "Chord-2"}>W
                    ...
                    <div onClick={handlePlay} className="drum-pad" id={bank ? "Heater-3" : "Chord-3"}>E
                    ...
                    <div onClick={handlePlay} className="drum-pad" id={bank ? "Heater-4" : "Shaker"}>A
                    ...
                    <div onClick={handlePlay} className="drum-pad" id={bank ? "Clap" : "Open-HH"}>S
                    ...
                    <div onClick={handlePlay} className="drum-pad" id={bank ? "Open-HH" : "Closed-HH"}>D
                    ...
                    <div onClick={handlePlay} className="drum-pad" id={bank ? "Kick-n'-Hat" : "Punchy-Kick"}>Z
                    ...
                    <div onClick={handlePlay} className="drum-pad" id={bank ? "Kick" : "Side-Stick"}>X
                    ...
                    <div onClick={handlePlay} className="drum-pad" id={bank ? "Closed-HH" : "Snare"}>C
